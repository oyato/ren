 ...
 */
export declare function $oren(opts: Partial<Options>): Options;
export declare namespace $oren {
    var options: Options;
    var ok: () => boolean;
    var online: () => boolean;
    var wait: (p?: {
    ...
    var onion: () => OnionAddr | undefined;
    var $api: string;
    var $: {
        mergeOpts: (r: typeof $oren, p: {
            prev: Options;
            next: Partial<Options>;
        }) => Options;
        wait: (r: typeof $oren, p: {
            timeoutMs: number;
        }) => WaitPromise;
